...
def main():
    courses = {
        "Bachelor of Science(Hons) in Information Technology": Course("Bachelor of Science(Hons) in Information Technology", 3),
...
with open("course_enrollment.py", "w") as file:
    file.write(code)

print("Code saved to course_enrollment.py")
